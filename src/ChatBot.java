public class ChatBot {
    ...
    // method that "returns" to user and gives them the heart emoticon
    public void forgot() {
        System.out.println("Oh wait! I forgot to give you this:");
        System.out.println("<3");
    }

    public int subtractNumbers(int num1, int num2, int num3) {
        return num1 - num2 - num3;
    }
}